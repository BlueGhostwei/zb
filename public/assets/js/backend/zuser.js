            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'true_name', title: __('True_name'), operate: 'LIKE', table: table, class: 'autocontent', formatter: Table.api.formatter.content},
                        ...
                        {field: 'code_num', title: __('Code_num')},
                        ...
                        {field: 'idcard_front_image', title: __('Idcard_front_image'), operate: false, events: Table.api.events.image, formatter: Table.api.formatter.image},
                        {field: 'idcard_opposite_image', title: __('Idcard_opposite_image'), operate: false, events: Table.api.events.image, formatter: Table.api.formatter.image},
                        {field: 'business_license_image', title: __('Business_license_image'), operate: false, events: Table.api.events.image, formatter: Table.api.formatter.image},
